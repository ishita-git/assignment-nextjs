...
export const companiesTabData = [
    ...
    },
    {
        ...
        des: "Established in 2008, Muskan Shipping Sdn. Bhd. began as an agency network in Malaysian ports. By 2010, it was officially founded in Port Kelang. With branch offices and sub-agents in India, the Gulf, and Europe, the company manages a container fleet of over 1000 units, operating closely with 'Muskan' Line's global network to provide efficient shipping services.",
