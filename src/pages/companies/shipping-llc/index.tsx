...
import shippingBg from '../../../assets/companies/shipping-llc-bg.png'
...
function ValuesBox({ image, title, desc }: { image: string | StaticImageData, title: String, desc: String }) {
    return <Box sx={{ bgcolor: "#FFFFFF", borderRadius: "1rem", p: "1.25rem", height: "15rem" }}>
        <Image src={image} alt="" style={{ height: "auto", width: "25%" }} />
        <Typography variant='h6' sx={{ textAlign: 'center', my: '1rem', color: '#1B1B1F' }}>
            {title}
        </Typography>
        <Typography variant='body1' sx={{ mb: '1rem', color: '#1B1B1F' }}>
            {desc}
        </Typography>
    </Box>
}
        ...
        <CompaniesLayout image={shippingBg} title='Muskaan Shipping LLC'>
            <Box sx={{ px: theme.spacing(4) }}>
                <Container maxWidth='xl' disableGutters>
                    ...
                    <Box sx={{ my: theme.spacing(3), mx: theme.spacing(4) }}>
                        <Box sx={{ mt: theme.spacing(3) }}>
                            <Grid container spacing={2}>
                                <Grid item sm={4} xs={6}>
                                    <ValuesBox key={CoreValuesData[0].id} image={CoreValuesData[0].image} title={CoreValuesData[0].title} desc={CoreValuesData[0].desc} />
                                </Grid>
                                <Grid item sm={4} xs={6}>
                                    <ValuesBox key={CoreValuesData[1].id} image={CoreValuesData[1].image} title={CoreValuesData[1].title} desc={CoreValuesData[1].desc} />
                                </Grid>
                                <Grid item sm={4} xs={12}>
                                    <ValuesBox key={CoreValuesData[2].id} image={CoreValuesData[2].image} title={CoreValuesData[2].title} desc={CoreValuesData[2].desc} />
                                </Grid>
                                <Grid item xs={6}>
                                    <Box
                                        sx={{
                                    ...
                                    >
                                        <ValuesBox key={CoreValuesData[3].id} image={CoreValuesData[3].image} title={CoreValuesData[3].title} desc={CoreValuesData[3].desc} />
                                    </Box>
                                </Grid>
                                <Grid item xs={6}>
                                    <Box
                                    ...
                                    >
                                        <ValuesBox key={CoreValuesData[4].id} image={CoreValuesData[4].image} title={CoreValuesData[4].title} desc={CoreValuesData[4].desc} />
                                    </Box>
                                </Grid>
                            </Grid>
                        </Box>
                    ...
                    <StatisticsCard exporterRank="15" importerRank="17" tradeBalanceRank="06" totalTradeAmtList={totalTradeAmtList} />
                </Container>
            </Box>
            <Box sx={{ position: "relative", mt: "4rem" }}>
                <Image src={visionBg} alt="" style={{ height: 'auto', width: "100%", }} />
                <Box sx={{ textAlign: 'start', position: "absolute", left: "0", top: "0", p: "4rem 8rem" }}>
