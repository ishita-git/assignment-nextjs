...
function ValuesBox({ image, title, desc }: { image: string | StaticImageData; title: String; desc: String }) {
    return (
        <Box sx={{ bgcolor: '#FFFFFF', borderRadius: '1rem', p: '2rem', height: '16rem' }}>
    ...
    return (
        <CompaniesLayout image={shippingBg} title='Muskaan Shipping LLC'>
            ...
            <Box sx={{ position: 'relative', mt: '4rem' }}>
                ...
                <Box sx={{ textAlign: 'start', position: 'absolute', left: '0', top: '0', p: '6rem 12rem' }}>
                    <Image src={visionIcon} alt='' style={{ height: 'auto', width: '6%' }} />
                    <Typography
                        variant='h3'
                    ...
                    <Typography
                        variant='body1'
                        sx={{ textAlign: 'start', color: '#FFFFFF', width: '46%', fontWeight: 400 }}
                    >
                        We are dedicated to offering our esteemed customers and partners a tangible experience through
                        personalized services, delivering effective and efficient solutions to their shipping and
