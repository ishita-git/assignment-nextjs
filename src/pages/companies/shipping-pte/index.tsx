    ...
    return (
        <CompaniesLayout image={shippingBg} title='Muskaan Shipping PTE Ltd.'>
            ...
            <Box sx={{ display: "flex", position: "relavtive" }}>
                ...
                <Box sx={{ position: "absolute", padding: '3rem 8rem', width: '70%', textAlign: 'start' }}>
                    ...
                    <Typography variant='body1' sx={{ textAlign: 'start', color: '#FFFFFF', fontWeight: 'bold' }}>
                        Our core values are our foundation for future success, guiding us in serving our customers and exploring new services and routes. We remain committed to shipping, especially intra-Asia routes, leveraging our deep regional ties. We prioritize staff development, pursue growth in emerging markets like Africa and South America, and invest in efficient vessels and land-based infrastructure. We believe our expertise and adaptability will continue to yield tangible results across diverse environments.
                    </Typography>
                </Box>
            </Box>
            <Box sx={{ px: theme.spacing(4) }}>
                <Container maxWidth='xl' disableGutters>
                    ...
                    <Grid container spacing={2} sx={{ mt: "4rem" }}>
                        ...
                        <Grid item xs={12} sm={4}>
                            <ServicesCard image={customBrokerageImg} title="Custom Brokerage" desc="Muskaan Shipping PTE LTD provides customs brokerage services for inbound and outbound shipments, including customs clearance and door-to-door delivery coordination. We also offer expert consultancy on import-export regulations and have invested in IT systems for efficient Electronic Data Interchange (EDI) with customs authorities." />
                        </Grid>
                        <Grid item xs={12} sm={4}>
                            <ServicesCard image={logImg} title="Logistic & Transportation" desc=" Our tailored services in Peninsular Malaysia include a wide range of trucks for prompt pick-up and delivery. We utilize multi-modal options, including road, rail, and water transport, along with a vast network of carriers for rapid response to changing needs." />
                        </Grid>
                    </Grid>
