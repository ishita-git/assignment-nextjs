            ...
            <Box sx={{ px: theme.spacing(4) }}>
                <Container maxWidth='xl' disableGutters>
                    ...
                    <Grid container spacing={1} sx={{ my: "1.5rem" }}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <ContainerType title="Open Top Containers" desc="Designed for oversize cargo, these containers have removable tops for easy loading and unloading." image={openTopContainer} />
