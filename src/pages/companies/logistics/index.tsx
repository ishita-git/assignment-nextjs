                ...
                <Container maxWidth='xl' disableGutters>
                    ...
                    <Box sx={{ display: 'flex', textAlign: 'center', flexWrap: 'wrap' }}>
                        {ContainerType.map((item, index) => (
                            ...
                            <Box key={index} sx={{ bgcolor: "#FFFFFF", margin: "2rem 1rem", width: "30%", p: "1.25rem", borderRadius: "1rem" ,height:"20rem"}}>
                                <Typography
                                    variant='h5'
                                    sx={{ color: '#031225', fontWeight: '400', textAlign: 'start' }}
                                >
                                ...
                                <Image src={item.image} alt="" style={{ height: "auto", width: '100%' }} />
                            </Box>
                        ))}
                    </Box>
