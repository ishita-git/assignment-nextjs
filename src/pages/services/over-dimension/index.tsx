        ...
        <ServicesLayout image={backgroundImg} title='Services'>
            <Box sx={{ mb: '2.5rem' }}>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} sm={6}>
                        ...
                        >
                            ...
                            increase in the procurement of specialized equipment, which includes flat racks, open tops,
                            and hard tops, available in both 20-foot and 40-foot configurations. What was once primarily
                            confined to the transport hubs of Nhava Sheva, Jebel Ali, and other ports within the Arabian
                            Gulf has now evolved into a comprehensive initiative spanning various regions.
                        </Typography>
                        <Typography
                            paragraph
                            variant='subtitle2'
                        ...
                        >
                            ...
                            additional ISC (Indian Subcontinent) ports, and even CIS (Commonwealth of Independent
                            States) destinations.
                        </Typography>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                ...
                >
                    ...
                    cell, headquartered in Mumbai. This specialized unit is tasked with ensuring the seamless and
                    effective operation of the expanded fleet, reflecting the Group's unwavering commitment to meeting
                    the unique demands of transporting over-dimension cargo on a global scale.
                </Typography>
            </Box>
        </ServicesLayout>
    )
