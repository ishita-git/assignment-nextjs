...
export default function JobDetail() {
    ...
    return (<Box>
        ...
        <Box sx={{ backgroundColor: '#EFF6FF' }}>
            <HeaderSection image={careerBackground} title={'Join Muskaan'} subtitle={"Unlock a World of Career Possibilities'"} />
            <Box sx={{ px: theme.spacing(12) }}>
                <Container maxWidth='xl'>
                    <Typography variant='h2' sx={{ mb: '1rem', textAlign: "start" }}>
                        {jobData?.title}
                    </Typography>
                    ...
                    <Box sx={{ my: theme.spacing(3) }}>
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={6}>
                                ...
                                <Typography variant='subtitle2' sx={{ color: '#031225', ml: '1.25rem', fontWeight: 300 }}>
