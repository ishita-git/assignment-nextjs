    ...
    return (
        <Box>
            ...
            <Box sx={{ mb: theme.spacing(4) }}>
                ...
                />
                <AboutDescription
                    body="Our footprint has been amplified with the establishment of our offices in Dubai, Port Klang, and Singapore, further solidifying our global presence."
                />
            </Box>
            <Grid container spacing={2} >
                <Grid item xs={12} sm={6}>
                    ...
                    <Typography textAlign={"start"} variant='body1' sx={{ color: "#031225", marginBottom: "1rem" }}>
                        Our commitment lies in elevating customer satisfaction by comprehending and fulfilling their specific needs. To achieve this, we actively pursue the following goals:
                    </Typography>
