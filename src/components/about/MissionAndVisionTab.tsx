        ...
        <Box>
            ...
            <Box>
                ...
                <Grid container spacing={4} alignItems="center" >
                    <Grid item xs={12} sm={6} justifyContent="left">
                        <Box sx={{ textAlign: "start" }}>
                            <Image src={targetImage} alt="" style={{ height: "auto", width: "25%", marginBottom: "2rem" }} />
                            <Typography variant='h3' sx={{ mb: '1.5rem', color: '#1B1B1F', textAlign: 'start' }}>
                                Our Mission
                            </Typography>
                            <Typography paragraph variant='body1' sx={{ fontWeight: 400, color: '#1B1B1F', textAlign: 'start' }}>
                                Our aim is to cater to our global clientele in the logistics and transportation sphere through innovative and economical supply chain solutions that consistently surpass their expectations. Our goal is to deliver utmost value, enhancing freight management efficiencies and generating substantial savings for our customers throughout the shipping process.
                                We hold steadfast in fostering strong customer relationships, considering them integral members of our team. Our commitment entails serving them with unwavering integrity and a sense of responsibility at all times.
                            </Typography>
                        </Box>
                    </Grid>
                ...
                <Grid container spacing={4} alignItems="center" sx={{ marginTop: "2rem" }}>
                    ...
                    <Grid item xs={12} sm={6} >
                        <Box sx={{ textAlign: "start" }}>
                            <Image src={visionImage} alt="" style={{ height: "auto", width: "25%", marginBottom: "2rem" }} />
                            <Typography variant='h3' sx={{ mb: '1.5rem', color: '#1B1B1F', textAlign: 'start' }}>
                                Our Vision
                            </Typography>
                            <Typography paragraph variant='body1' sx={{ fontWeight: 400, color: '#1B1B1F', textAlign: 'start' }}>
                                Our pursuit of excellence centers on delivering world-class logistics services. We are consistently prepared to cater to our customers' requirements around the clock. Our primary objective is to establish enduring partnerships with our esteemed clients by consistently offering this elevated standard of service.
                                We exert great effort to present our clients with more than just reactive assistance; our proactive approach, powered by our expertise, aids in not only delivering exceptional service but also guiding our clients effectively within the realms of land and sea logistics.
                            </Typography>
                        </Box>
                    </Grid>
                </Grid>
